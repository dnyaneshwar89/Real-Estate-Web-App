...
def contact(request):
    if request.method == 'POST':
        ...
        send_mail(
            ...
            'There has been an inquiry for' + listing + '.' + 'Sign in to admin panel to see more info.',
            'dnyaneshwar.birajdar@spit.ac.in',
            ['dnyaneshwarbirajdar89@gmail.com',realtor_email],
            fail_silently=False
        )
